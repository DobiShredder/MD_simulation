...
def main() -> None:
    ...
    parser.add_argument("input_topology", type=Path, help="Processed GROMACS topology")
    parser.add_argument("output_topology", type=Path, help="Topology with hot atom types")
