...
if (( dry_run )); then
    ...
    echo '+ python3 ../make_window_replicas.py gareus config.toml work/system.parm7 work/system.rst7 work'
    exit 0
fi
...
"$python" ../make_window_replicas.py gareus "$config" "$work_dir/system.parm7" "$work_dir/system.rst7" "$work_dir"
