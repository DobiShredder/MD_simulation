...
def main() -> None:
    ...
    parser.add_argument("base_topology", type=Path, help="Unscaled processed topology")
    parser.add_argument("states", type=Path, help="Resolved REST3 state table")
    parser.add_argument("replica_directory", type=Path, help="Directory containing replica topologies")
