...
def show_help() -> None:
    print("Usage: python3 anal.py")
    print()
    print("Analyze completed RBFE production segments with Amber FE-ToolKit MBAR/BAR.")
    print()
    print("Environment:")
    print("  WORK_DIR       Read simulation outputs from this directory (default: work).")
