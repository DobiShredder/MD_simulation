...
do
	...
	$gmx grompp -f min${i}/min${i}.mdp -c ../input.gro -r ../input.gro -p ../topol.top -o min${i}/min${i}.tpr
	cd ..
done
...
do
	...
	$gmx grompp -f eq${i}/eq${i}.mdp -c ../1_min/min${i}/min${i}.gro -r ../1_min/min${i}/min${i}.gro -p ../topol.top -o eq${i}/eq${i}.tpr
	cd ..
done
...
do
	...
	$gmx grompp -f ti${i}/ti${i}.mdp -c ../2_eq/eq${i}/eq${i}.gro -p ../topol.top -o ti${i}/ti${i}.tpr
	cd ..
done
