#!/usr/bin/env python3
"""3HTB에서 T4 lysozyme와 bound JZ4 coordinate를 준비합니다."""
...
def parse_arguments() -> argparse.Namespace:
    parser = argparse.ArgumentParser(
        description="PDB 3HTB의 T4 lysozyme–JZ4 complex를 전처리합니다."
    )
    parser.add_argument("input_pdb", type=Path, help="다운로드한 3HTB PDB")
